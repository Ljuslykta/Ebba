...
const pregnancyInfo = [
    ...
    { week: 3, title: "Vecka 3: Start me up", description: "Nu fästs ägget i livmodern..", image: getImagePath(3) },
    { week: 4, title: "Vecka 4: Mother(kakan)", description: "Nu finns två typer av celler, dels det som kommer bli barnet och de som kommer bli moderkakan.", image: getImagePath(4) },
